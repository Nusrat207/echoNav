...
class _FreemiumModelScreenState extends State<FreemiumModelScreen> {
  ...
  void _startVoiceNavigation() async {
    ...
    //       "Welcome to the freemium model. Let me explain our subscription plans. All our plans offer faster object recognition, unlimited prompts. Our Yearly plan is normally 900, now only 600 with 33% savings and 7 days free trial. This is our BEST VALUE plan. Our 3 Months plan is usually 300, now only 220 with 27% savings and 3 days free trial. This is our MOST POPULAR plan. Our 1 Month plan is 100, now only 80 with 20% savings. Please say 'Yearly', '3 Months', or '1 Month' to select your preferred plan.");
    await _flutterTts.speak(
        "say 'Yearly', '3 Months', or '1 Month' to select your preferred plan.");
    _startListening();
  }
  ...
  void _startListening() async {
    ...
    _speechToText.listen(
      ...
      listenFor: Duration(seconds: 10), // Adjust listen duration as needed
  ...
  Future<void> _handleVoiceCommand(String command) async {
    ...
    if (command.contains('yearly') || command.contains('early')) {
      setState(() => selectedPlan = 'Yearly');
      print("yearly selected");
      _flutterTts.speak("Yearly plan selected");
      _handleContinue();
    } else if (command.contains('three months') ||
        command.contains('three') ||
        command.contains('3 months')) {
      setState(() => selectedPlan = '3 Months');
      print("3 months selected");
      _flutterTts.speak("3 Months plan selected");
      _handleContinue();
    } else if (command.contains('one month') || command.contains('one')) {
